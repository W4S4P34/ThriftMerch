...
public class OrderDetailsCustomerView extends AbstractView<IOrderDetailsCustomerViewController>
		implements IOrderDetailsCustomerView {
	...
	public OrderDetailsCustomerView(IOrderDetailsCustomerViewController viewController) throws IOException {
	...
	public void updateViewOrderDetails(Order order) {
		/*
		 * ID: left Address: left Date: left Status: center Total Items: left Total
		 * Price: right Items
		 */
