...
public class OrdersShopView extends AbstractView<IOrdersShopViewController> implements IOrdersShopView {
	...
	public OrdersShopView(IOrdersShopViewController viewController) throws IOException {
	...
	public void updateOrderView() {
		...
		if (Program.actor.ViewAllOrder() == null) {
		...
		for (Order item : Program.actor.ViewAllOrder()) {
