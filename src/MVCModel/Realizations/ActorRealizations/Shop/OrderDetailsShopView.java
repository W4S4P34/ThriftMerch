...
public class OrderDetailsShopView extends AbstractView<IOrderDetailsShopViewController>
		implements IOrderDetailsShopView {
	...
	public OrderDetailsShopView(IOrderDetailsShopViewController viewController) throws IOException {
	...
	public void updateMainOrderDetailsView(Order order) {
		...
		orderAddressLabel = new JLabel("Address: " + order.GetCustomer().GetAddress());
