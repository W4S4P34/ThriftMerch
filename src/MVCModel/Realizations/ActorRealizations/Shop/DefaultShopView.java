...
public class DefaultShopView extends AbstractView<IDefaultShopViewController> implements IDefaultShopView {
	...
	private JButton productDetailsButton, productRemoveButton;
	...
	private JButton addProductButton, logoutButton, listButton;
	...
	public DefaultShopView(IDefaultShopViewController viewController) throws IOException {
	...
	public void repaintContentPanel(ArrayList<Product> productList) {
		...
		int _DEFAULT_PRODUCT_FRAME_HEIGHT = 420;
		...
		for (int i = 0; i < rowNumber; i++) {
			...
			for (int j = 0; j < _PRODUCT_LIMIT_ON_ROW; j++) {
				...
				productButtonPanel.setPreferredSize(new Dimension(frameDim.width, 80));
